    ...
    <script>
        $('document').ready(function() {
            ...
            .then(data => {
                ...
                var assessment = `http://${serverClientIP}/Beyond%20the%20Classroom/qr-self-assessment.html?module_id=${module_id}&id=${id}&type=${userType}`;
                var encodedAssessmentURL = encodeURIComponent(assessment);
                console.log(encodedAssessmentURL);
    ...
    <div class="module-overview_container">
        <div class="module-overview_imageSection" id="assesmentQR">
            ...
            <div class="module-overview_Qrcode">
                ...
                <img id="assessmentQR" alt="<?php echo $rows['module_id']; ?>">
            </div>
        </div>
        <div class="module-overview_texts">
            ...
            <div style="display:flex;justify-content: flex-end;margin:0">
                <a href="module-edit.php?id=<?= $rows['module_id'] ?>" title="edit" style="display:flex;color:#535353" id="editModuleBtn"> 
                ...
                <?php while ($mrows = mysqli_fetch_assoc($material)) { ?>
                    <div class="tab">
                        ...
                        <label class="tab-label" for="rd<?= $mrows['material_id'] ?>">
                            ...
                            <div>
                                <img src="assets/arrowIcon.svg" width="20" height="20" alt="arrowIcon">
                            </div>
                        </label>
                        <div class="tab-content">
                            <a href="<?= $mrows['material_link'] ?>"><button>Download</button></a>
                            <a href="material-edit.php?id=<?= $mrows['material_id'] ?>&mid=<?php echo $id;?>" class="editMaterialBtn"><button>Edit</button></a>
                        </div>
                    </div>
                <?php } ?>
            </div>
